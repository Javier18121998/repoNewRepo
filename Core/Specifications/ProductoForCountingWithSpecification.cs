...
{
    public class ProductoForCountingWithSpecification : BaseSpecification<Producto>
    {
        public ProductoForCountingWithSpecification(ProductoSpecificationParams productoParams)
            : base(x =>
